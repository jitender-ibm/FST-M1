...
public class Activity2 {
    ...
    @Test
    public void GetTheUrlOfTheHeadermage(){
        ...
        //Getting the image url using attribute of the element
        String imageLink =  driver.findElement(By.xpath("//div[@class = 'companylogo']/img")).getAttribute("src");
