...
public class Activity4 {
    ...
    public void loggingIntoTheSite(){
        ...
        WebElement element = driver.findElement(By.cssSelector("ul.nav-dashboard"));
        //Verifying if the homepage has been opened
        boolean flag = element.isDisplayed();
        if (flag) {
            System.out.println("Homepage has been opened");
        } else {
            System.out.println("Homepage is not opened yet");
        }
    }
